PROJECT_NAME := ble_app_beacon_s130_pca10028
...
INC_PATHS  = -I$(abspath ../../../config/ble_app_beacon_s130_pca10028)
...
nrf51422_xxac_s130: LINKER_SCRIPT=ble_app_beacon_gcc_nrf51.ld
